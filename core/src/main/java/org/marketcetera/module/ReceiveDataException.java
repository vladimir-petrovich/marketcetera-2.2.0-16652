 ...
 * @version $Id: ReceiveDataException.java 16154 2012-07-14 16:34:05Z colin $
 * @since 1.0.0
 * @see DataReceiver#receiveData(DataFlowID, Object) 
 */
@ClassVersion("$Id: ReceiveDataException.java 16154 2012-07-14 16:34:05Z colin $") //$NON-NLS-1$
